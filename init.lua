-- Store global Vim in a local vim variable, doing this just to avoid lsp warnings
local vim = vim

-- Nodesetup for projects using old Node.js
...
local plugins = {
		...
		config = function()
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					-- This may be unwanted, since inlay hints displace some of the code
	...
	{ -- Linting
		...
		config = function()
			...
			-- Don't show warnings in ignored files
	...
	{ -- Autocompletion
		...
		config = function()
			...
			luasnip.add_snippets(nil, {
				javascript = console_log_snippet,
				typescript = console_log_snippet,
				javascriptreact = console_log_snippet,
				typescriptreact = console_log_snippet,
			})
...
vim.keymap.set("n", "<leader>s", ":%s/\\<<C-r><C-w>\\>//c<Left><Left>")
vim.keymap.set("v", "<leader>s", '"ay:%s/\\<<C-r>a\\>//c<Left><Left>')
...
vim.keymap.set("n", "<leader>gs", function()
	...
	if err ~= nil and err.code ~= nil then
		print(err.code)
	end
